...
export const OAUTH_CONFIG = {
    google: {
        clientId: import.meta.env.VITE_GOOGLE_CLIENT_ID || '115907322645-is27479b0l7m1tvk5miis6f6o2edusom.apps.googleusercontent.com',
 ...
 */
export async function handleGoogleCallback(_code) {
 ...
 */
export async function handleGithubCallback(_code) {
 ...
 */
export function initiateOAuthFlow(provider) {
    ...
    window.open(authUrl, `${provider}_auth`, `width=${width},height=${height},left=${left},top=${top},resizable,scrollbars`);
}
/**
 ...
 */
export function getOAuthProviderFromUrl() {
